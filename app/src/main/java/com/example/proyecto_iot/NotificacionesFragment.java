...
public class NotificacionesFragment extends Fragment {
    ...
    private void generarPdfItext() {
        try {
            ...
            table.addHeaderCell(new Cell().add(new Paragraph("Vehículo").setBold())
                    .setBackgroundColor(ColorConstants.LIGHT_GRAY));
    ...
    private void cargarHistorialFirestore() {
        ...
        firestore.collection("Coches")
                ...
                .addOnSuccessListener(carsSnap -> {
                    ...
                    for (QueryDocumentSnapshot c : carsSnap) {
                        carIds.add(c.getId());
                        carNames.put(c.getId(), c.getString("Nombre"));
                    }
    ...
    private void openFilterPopup() {
        ...
        // tipos
        List<String> types = List.of("Todos", "Alarmas", "Puertas", "Impacto", "Seguridad");
    ...
    private Notificacion buildNotificacionFromEvento(String tipo,
        ...
        switch (tipo) {
            ...
            case "safe_mode": {
                ...
                return new Notificacion(
                        "Modo seguro",
                        (on ? "Activado" : "Desactivado") + " en " + carName,
                        fecha,
            ...
            case "puerta": {
                ...
                return new Notificacion(
                        open ? "Puertas abiertas" : "Puertas bloqueadas",
                        "Estado de puertas en " + carName,
                        fecha,
                        R.drawable.ic_info,
                        carName,
                        "Puertas",
    ...
    private void openDatePicker(boolean from, DatePickedCallback cb) {
    ...
    private static class ItemTemp {
        ...
        ItemTemp(Notificacion n, long t) {
            notif = n;
            ts = t;
        }
    }
